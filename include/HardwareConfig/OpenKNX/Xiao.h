...
// OpenKNXiao ESP32S3 pins
    ...
    #define KNXIAO_ESP32S3_PIN1 2 // GPIO2  | SPI0 TX  | UART1 RTS | I2C1 SDA | PWM1 A
    #define KNXIAO_ESP32S3_PIN2 3 // GPIO3  | SPI0 RX  | UART1 TX  | I2C1 SCL | PWM1 B
    #define KNXIAO_ESP32S3_PIN3 4 // GPIO4  | SPI0 RX  | UART1 TX  | I2C0 SDA | PWM2 A
    #define KNXIAO_ESP32S3_PIN4 5 // GPIO5  | SPI0 TX  | UART1 RX  | I2C0 SCL | PWM2 B
    #define KNXIAO_ESP32S3_PIN5 6 // GPIO6  | SPI1 SCK | UART1 CTS | I2C1 SDA | PWM3 A
    #define KNXIAO_ESP32S3_PIN6 7 // GPIO7  | SPI1 SCK | UART1 CTS | I2C1 SCL | PWM3 B
    #define KNXIAO_ESP32S3_PIN7 8 // GPIO8  | SPI1 RX  | UART1 TX  | I2C0 SDA | PWM4 A
    #define KNXIAO_ESP32S3_PIN8 9 // GPIO9  | SPI1 TX  | UART1 RX  | I2C0 SCL | PWM4 B
#endif
